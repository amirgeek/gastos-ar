export const KNOWN_ACCOUNT_OPTIONS = [
  ...
  { id: 'personal-pay', label: 'Personal Pay', kind: 'wallet', accountType: 'wallet', yieldType: 'Cuenta remunerada', tna: 24.5, limit: 750000, source: 'Tasa estimada de referencia' },
  ...
  { id: 'belo', label: 'Belo', kind: 'wallet', accountType: 'wallet', yieldType: 'Cuenta remunerada', tna: 24.8, limit: 1000000, source: 'Tasa estimada de referencia' },
  { id: 'brubank', label: 'Brubank', kind: 'bank', accountType: 'bank', yieldType: 'Cuenta remunerada', tna: 24.0, limit: 750000, source: 'Tasa estimada de referencia' },
  ...
  { id: 'plazo-fijo-banco-galicia', label: 'Plazo fijo Banco Galicia', kind: 'fixed-term', accountType: 'investment', yieldType: 'Plazo fijo 30 días', tna: 28.0, source: 'Referencia estructurada con tasa estimada' },
  { id: 'plazo-fijo-banco-nacion', label: 'Plazo fijo Banco Nación', kind: 'fixed-term', accountType: 'investment', yieldType: 'Plazo fijo 30 días', tna: 27.5, source: 'Referencia estructurada con tasa estimada' },
];
